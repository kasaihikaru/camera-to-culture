class ClientsController < ApplicationController
	...
	def index
		...
		array_cls = Client.active.consent.registerd.intro_present.includes({user: [user_languages: :language]}, :client_portfolios).fits_categpory_id_in(params[:category_ids]).fits_prefecture_id_in(params[:prefecture_ids]).uniq.shuffle!
